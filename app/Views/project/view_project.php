        ...
        <span class="d-flex justify-content-center mb-4 mt-0" style="font-weight: bold; font-size: 20px;"><span class="underline-text">Edit Project</span></span>
            ...
            <div class="form-group mb-4">
              <div class="row">
                  ...
                  <div class="col-md-6 mt-3">
                      <label class="control-label">Project Alias Name</label>
                      <input type="text" name="project_alias" id="globalProjectName" class="custom-form" value="<?= $project['project_alias_name']?>">
                  </div>
