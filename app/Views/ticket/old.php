          ...
          <div class="col-12">
            ...
            <div class="tab-content" id="custom-content-below-tabContent">
              <div class="tab-pane fade" id="custom-content-below-home" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                <div class="card">
                  <div class="card-body">
                    <table id="dataTableFull" class="table table-hover table-bordered">
                        <thead>
                        <tr>
                          <th></th>
                ...
                <div class="card-body">
                  <div class="tab-content" id="custom-content-below-tabContent">
                      <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                        <table id="dataTableFull1" class="table table-hover table-bordered">
                          <thead>
                            <tr>
                              <th>TITLE</th>
                              <th>CLIENT</th>
...
<div class="modal fade" id="add-project-modal">
  <div class="modal-dialog modal-lg">
    ...
    style="color:#000; margin: -10px -5px 0 0"><i class="bi bi-x-circle text-danger" style="font-size:22px!important"></i></a> -->
      ...
      <div class="modal-body form" style="margin-top: -1.5rem">
            ...
            <div class="form-group mb-4">
              <div class="row">
                <div class="col-md-4 mt-3">
                  ...
                  <input type="text" name="project_name" class="custom-form">
                  </select>
                </div>
                ...
                <div class="col-md-4 mt-3">
                  ...
                  <select class="select2 custom-form" name="label" required data-placeholder="Select Status" data-dropdown-css-class="select2-primary"  style="width: 100%;">
              ...
              <div class="row">
                  <div class="col-md-4 mt-3">
                    ...
                    <input type="text" name="tag" class="custom-form" value="">
                  </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <textarea name="description" class="custom-form" rows="8"></textarea>
                </div>
              </div>
            </div>
        </div>
        <div class="modal-footer border-0" style="margin-top: -2rem">
            ...
            <button type="submit" id="createAssignProjectBtn" class="custom-btn bg-primary text-decoration-none text-white"><i class="bi bi-check-circle"></i> &nbsp;Save</button>
            </form>
        </div>
      </div>
    </div>
    <!-- CHART -->
    <script>
      const all = $('#allCount').val()
      const countNs = $('#countresNs').val()
      const countIp = $('#countresIp').val();
      const countOh = $('#countresOh').val()
      const countCl = $('#countresCl').val()
      const countCm = $('#countresCm').val()
      const countAr = $('#countresAr').val()
      $('#countAll').html(all)
