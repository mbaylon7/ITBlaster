                    ...
                    head += `
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item active"><i class="bi bi-lightbulb"></i> <a href="/">${owner.company}’s</a> &nbsp; Project</li>
                                </ol>
                            </div>`;
                    html3 = ``;
        ...
        $(document).on('click', '.view-ticket-details', function(e){
            ...
            $.get('/ticket/ticket-details/' + id, function(res) {
                ...
                $('#ticket_label').html(
                    ...
                    <select class="select2 custom-form" id="labelVal" data-label="${ticket.ticket_label}" name="label" required data-placeholder="Select Priority" data-dropdown-css-class="select2-primary"  style="width: 100%;">
    ...
    function getAllProjectTicket() {
        ...
        $.get(`/project/project-tickets=${id}`)
            ...
            dom: "<'row'<'col-md-12 d-flex justify-content-end'B>><'row'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r><'table-scrollable't><'row'<'col-md-5 col-sm-12'i><'col-md-7 col-sm-12'p>>",
                ...
                dataTableButtons.appendTo(dataTableButtonsContainer);
                showOffcanvas();
            })
            .fail((error) => {
                console.error('Error:', error);
